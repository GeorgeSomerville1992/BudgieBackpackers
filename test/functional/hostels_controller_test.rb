...
class HostelsControllerTest < ActionController::TestCase
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post :create, hostel: { address: @hostel.address, latitude: @hostel.latitude, longitude: @hostel.longitude }
    end
  ...
  test "should update hostel" do
    put :update, id: @hostel, hostel: { address: @hostel.address, latitude: @hostel.latitude, longitude: @hostel.longitude }
    assert_redirected_to hostel_path(assigns(:hostel))
  end
