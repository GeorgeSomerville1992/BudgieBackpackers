...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { address: @attraction.address, latitude: @attraction.latitude, longitude: @attraction.longitude }
    end
  ...
  test "should update attraction" do
    put :update, id: @attraction, attraction: { address: @attraction.address, latitude: @attraction.latitude, longitude: @attraction.longitude }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
